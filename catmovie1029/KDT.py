...
from catmovie1029.ExceptClass import assertException
        ...
        if not cls.driver.get(type):
            ...
            if type=="Chrome":
                cls.driver[type] = webdriver.Chrome(
                    executable_path=r'D:\study\threestudy\fourstudy\catmovie1029\drivers\chromedriver.exe',chrome_options=options)
            elif type=="Firefox":
